 ...
 * intent.putExtra(FBReader.BOOK_KEY
 * ,Environment.getExternalStorageDirectory()+"/book/txt.txt");
 * intent.putExtra("goto_position", false); startActivity(intent);
 * 
 * @author 12
 * 
 */
public final class FBReader extends Activity implements ZLApplicationWindow
{
	...
	private MenuPop menu= new MenuPop();
