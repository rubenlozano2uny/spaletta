    ...
    implements HasViews
{
    ...
    public static BookActivity_.IntentBuilder_ intent(Fragment supportFragment) {
    ...
    private void injectExtras_() {
        ...
        if (extras_!= null) {
            if (extras_.containsKey(BOOK_EXTRA)) {
                book = ((Book) extras_.getSerializable(BOOK_EXTRA));
            }
        }
    }
    ...
    public static class IntentBuilder_ {
        ...
        public BookActivity_.IntentBuilder_ book(Book book) {
            intent_.putExtra(BOOK_EXTRA, ((Serializable) book));
            return this;
        }
