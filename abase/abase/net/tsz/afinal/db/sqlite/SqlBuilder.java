...
public class SqlBuilder
{
	...
	public static String getCreatTableSQL(Class<?> clazz)
	{
		...
		if (primaryClazz == int.class || primaryClazz == Integer.class) strSQL.append("\"").append(id.getColumn()).append("\"    ")
				.append("INTEGER PRIMARY KEY AUTOINCREMENT,");
		else strSQL.append("\"").append(id.getColumn()).append("\"    ").append("TEXT PRIMARY KEY,");
	 ...
	 * @param key
	 * @param value
	 * @return eg1: name='abase' eg2: id=100
	 */
