...
public class ItemView<T> extends LinearLayout
{
	...
	public void bind(T item, AbaseAdapter<T> adapter)
	{
	...
	public static ItemView bindView(Context context, Class clazz, View convertView, Object bindObj, AbaseAdapter adapter)
	{
