...
public class AbaseBitmap {
	 ...
	 * @return
	 */
	public AbaseBitmap configDiskCachePath(String strPath){
	 ...
	 * @param size 缓存大小
	 */
	public AbaseBitmap configMemoryCacheSize(int size){
	 ...
	 */
	public AbaseBitmap configMemoryCachePercent(float percent){
	 ...
	 * @param size
	 */
	public AbaseBitmap configDiskCacheSize(int size){
	 ...
	 * @param size
	 */
	public AbaseBitmap configBitmapLoadThreadSize(int size){
		if(size >= 1)
	 ...
	 * @return
	 */
	public AbaseBitmap configRecycleImmediately(boolean recycleImmediately){
