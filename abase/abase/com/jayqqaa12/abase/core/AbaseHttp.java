...
public class AbaseHttp
{
	...
	public AbaseHttp()
	{
		...
		ConnManagerParams.setTimeout(params, AbaseHttp.DEFAULT_CONN_TIMEOUT);
		HttpConnectionParams.setSoTimeout(params, AbaseHttp.DEFAULT_CONN_TIMEOUT);
		HttpConnectionParams.setConnectionTimeout(params, AbaseHttp.DEFAULT_CONN_TIMEOUT);
	...
	public AbaseHttp configResponseTextCharset(String charSet)
	{
	...
	public AbaseHttp configHttpRedirectHandler(HttpRedirectHandler httpRedirectHandler)
	{
		this.httpRedirectHandler = httpRedirectHandler;
		return this;
	}

	public AbaseHttp configHttpCacheSize(int httpCacheSize)
	{
	...
	public AbaseHttp configUserAgent(String userAgent)
	{
		HttpProtocolParams.setUserAgent(this.httpClient.getParams(), userAgent);
		return this;
	}

	public AbaseHttp configTimeout(int timeout)
	{
	...
	public AbaseHttp configRegisterScheme(Scheme scheme)
	{
		this.httpClient.getConnectionManager().getSchemeRegistry().register(scheme);
		return this;
	}

	public AbaseHttp configSSLSocketFactory(SSLSocketFactory sslSocketFactory)
	{
	...
	public AbaseHttp configRequestRetryCount(int count)
	{
		this.httpClient.setHttpRequestRetryHandler(new RetryHandler(count));
		return this;
	}

	public AbaseHttp configRequestThreadPoolSize(int threadPoolSize)
	{
