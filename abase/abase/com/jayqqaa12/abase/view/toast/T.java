...
package com.jayqqaa12.abase.view.toast;
...
public class T
{
	...
	/**
	 * Make a {@link T} that just contains a text view.
	 * 
	 * @param context
	 *            The context to use. Usually your {@link android.app.Activity}
	 *            object.
	 ...
	 */
	public static void makeText(Activity context, CharSequence text, Style style)
	{
		  makeText(context, text, style, R.layout.app_msg);
	}

	/**
	 * @author mengguoqiang 扩展支持设置字体大小 Make a {@link T} that just contains a
	 *         text view.
	 * 
	 * @param context
	 *            The context to use. Usually your {@link android.app.Activity}
	 ...
	 *            The style with a background and a duration.
	 */
	public static T makeText(Activity context, CharSequence text, Style style, float textSize)
	{
		return makeText(context, text, style, R.layout.app_msg, textSize);
	}

	/**
	 * Make a {@link T} with a custom layout. The layout must have a
	 ...
	 *            The style with a background and a duration.
	 */
	public static T makeText(Activity context, CharSequence text, Style style, int layoutId)
	{
	...
	/**
	 * @author mengguoqiang 扩展支持字体大小 Make a {@link T} with a custom layout. The
	 *         layout must have a {@link TextView} com id
	 ...
	 *            The style with a background and a duration.
	 */
	public static T makeText(Activity context, CharSequence text, Style style, int layoutId, float textSize)
	{
		LayoutInflater inflate = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		View v = inflate.inflate(layoutId, null);
	...
	/**
	 * Make a non-floating {@link T} with a custom view presented inside the
	 * layout. It can be used to create non-floating notifications if floating
	 * is false.
	 * 
	 * @param context
	 *            The context to use. Usually your {@link android.app.Activity}
	 ...
	 *            The style with a background and a duration.
	 */
	public static T makeText(Activity context, CharSequence text, Style style, View customView)
	{
		return makeText(context, text, style, customView, false);
	}

	/**
	 * Make a {@link T} with a custom view. It can be used to create
	 ...
	 *            true if it'll float.
	 */
	private static T makeText(Activity context, CharSequence text, Style style, View view, boolean floating)
	{
	...
	/**
	 * 
	 * @author mengguoqiang 扩展支持设置字体大小 Make a {@link T} with a custom view. It
	 *         can be used to create non-floating notifications if floating is
	 *         false.
	 * 
	 * @param context
	 *            The context to use. Usually your {@link android.app.Activity}
	 ...
	 *            true if it'll float.
	 */
	private static T makeText(Activity context, CharSequence text, Style style, View view, boolean floating, float textSize)
	{
		T result = new T(context);
	 ...
	 *            true if it'll float.
	 */
	public static T makeText(Activity context, int resId, Style style, View customView, boolean floating)
	{
		return makeText(context, context.getResources().getText(resId), style, customView, floating);
	}

	/**
	 * Make a {@link T} that just contains a text view with the text from a
	 * resource.
	 * 
	 * @param context
	 *            The context to use. Usually your {@link android.app.Activity}
	 ...
	 */
	public static void makeText(Activity context, int resId, Style style) throws Resources.NotFoundException
	{
		  makeText(context, context.getResources().getText(resId), style);
	}

	/**
	 * Make a {@link T} with a custom layout using the text from a resource.
	 ...
	 *             if the resource can't be found.
	 */
	public static void makeText(Activity context, int resId, Style style, int layoutId) throws Resources.NotFoundException
	{
		makeText(context, context.getResources().getText(resId), style, layoutId);
	}
	...
	/**
	 * @return <code>true</code> if the {@link T} is being displayed, else
	 *         <code>false</code>.
	 */
	...
	/**
	 * Cancels all queued {@link T}s. If there is a {@link T} displayed
	 * currently, it will be the last one displayed.
	 */
	...
	{
		if (mView == null) { throw new RuntimeException("This AppMsg was not created with AppMsg.makeText()"); }
		TextView tv = (TextView) mView.findViewById(android.R.id.message);
		if (tv == null) { throw new RuntimeException("This AppMsg was not created with AppMsg.makeText()"); }
		tv.setText(s);
	}
	 ...
	 */
	public T setLayoutParams(LayoutParams layoutParams)
	{
	 ...
	 */
	public T setLayoutGravity(int gravity)
	{
	...
	public static class Style
	{
		...
		/**
		 * Construct an {@link T.Style} object.
		 * 
		 * @param duration
		...
		{
			if (!(o instanceof T.Style)) { return false; }
			Style style = (Style) o;
